...
const HeroText = () => {
  const words = ["Smart", "Innovative", "Scalable"];
  const variants = {
  ...
  return (
    <div className="z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text">
      {/* Desktop View */}
      <div className="flex-col hidden md:flex leading-loose">
        <motion.h1
          ...
          transition={{ delay: 1 }}
        >
          Hi I'm <span className="text-5xl font-semibold">Kunal Sharma</span>
        </motion.h1>
